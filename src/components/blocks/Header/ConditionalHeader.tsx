...
export default function ConditionalHeader() {
  ...
  if (!showPrivate && !showPublic) {
    return (
      <nav className="fixed top-0 left-0 right-0 z-20 flex items-center justify-between px-5 py-4 md:px-10 bg-white/80 dark:bg-[#0c0b18]/60 backdrop-blur-md border-b border-gray-200 dark:border-white/10">
