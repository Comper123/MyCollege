...
export default function PrivateHeader() {
  ...
  return (
    <nav className="flex items-center justify-between px-5 py-4 md:px-10 bg-white/80 dark:bg-[#0c0b18]/60 backdrop-blur-md border-b border-gray-200 dark:border-white/10 transition-colors">
