...
export default function Modal({ size = 'md', children, isOpen, onClose, title, className = ''} : ModalProps){
  ...
  return (
    <div 
      ...
      <div
        ref={modalRef} 
        className={`p-8 pt-0 bg-white dark:bg-[#1a1927] relative rounded-xl ${modalClasses[size]} max-h-[95vh] overflow-y-auto scrollbar-thin ${className }`}>
